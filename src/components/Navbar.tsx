...
import { User, Menu, X, Compass, Sparkles, Mail, Newspaper } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 w-full glass-panel border-b border-white/5 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5 sm:gap-4 shrink-0">
          ...
          <Link href="/login" className="flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 rounded-full text-xs sm:text-sm font-semibold text-white gradient-btn shadow-md hover:scale-[1.02] active:scale-[0.98] transition-all whitespace-nowrap">
