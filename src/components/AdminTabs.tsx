...
import { LayoutDashboard, BookOpen, Sparkles, Newspaper, Award, Users, Megaphone, ListChecks } from "lucide-react";
...
const TABS = [
  ...
  { href: "/admin/campagnes", label: "Pixel & campagnes", icon: Megaphone },
